...
Optimización Técnica (Respuesta a Negocio) 💡
Para alinear el modelo con una política de riesgos conservadora, se aplicaron dos mejoras críticas:
Estandarización (StandardScaler): Para normalizar las escalas de las variables financieras y asegurar una convergencia óptima del algoritmo.
